...
export async function onRequest({ env, request }) {
  ...
  lines.push(
    ...
    ' if(location.pathname.indexOf("unplug-admin-dashboard.html")!==-1) add("/media/scripts/agreement-control-centre-forms.js?v=20260913-1","dashboard-forms");',
