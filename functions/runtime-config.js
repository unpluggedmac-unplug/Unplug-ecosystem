...
export async function onRequest({ env, request }) {
  ...
  lines.push(
    ...
    ' if (document.querySelector("script[data-unplug-member-control-centre]")) return;',
    ' var s=document.createElement("script");',
    ' s.src="/media/scripts/member-dashboard-control-centre.js?v=20260913-1";',
    ' s.async=false;',
    ' s.setAttribute("data-unplug-member-control-centre","true");',
    ' (document.head||document.documentElement).appendChild(s);',
    '})();',
    '',
