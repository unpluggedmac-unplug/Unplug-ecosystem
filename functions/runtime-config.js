...
export async function onRequest({ env, request }) {
  ...
  lines.push(
    ...
    '})();',
    '',
    '// Hierarchical Control Centre navigation and admin deep links.',
    '(function(){',
    ' var p=String(location.pathname||"").toLowerCase();',
    ...
    ' var s=document.createElement("script");',
    ' s.src="/media/scripts/admin-control-centre-hierarchy.js?v=20260913-1";',
    ' s.async=false;',
    ' s.setAttribute("data-unplug-control-centre-hierarchy","true");',
    ' (document.head||document.documentElement).appendChild(s);',
    '})();',
    '',
    '// Member Dashboard Control Centre. Kept separate from the admin hierarchy so',
    '// the member redesign can be developed and validated independently.',
    '(function(){',
    ' var p=String(location.pathname||"").toLowerCase();',
    ' if (p.indexOf("unplug-member-dashboard")===-1) return;',
    ' function addCss(href,attr){ if(document.querySelector("link["+attr+"]")) return; var l=document.createElement("link"); l.rel="stylesheet"; l.href=href; l.setAttribute(attr,"true"); (document.head||document.documentElement).appendChild(l); }',
    ' function addScript(src,attr){ if(document.querySelector("script["+attr+"]")) return; var s=document.createElement("script"); s.src=src; s.async=false; s.setAttribute(attr,"true"); (document.head||document.documentElement).appendChild(s); }',
    ' addCss("/media/styles/member-dashboard-control-centre.css?v=20260913-1","data-member-control-centre-css");',
    ...
    '  if (location.pathname.indexOf("unplug-admin-dashboard") === -1) return;',
    ...
    '  a.href="/unplug-agreement-generator-admin";',
    ...
    ' }',
    ' if(location.pathname.indexOf("unplug-agreement-generator")!==-1 && location.pathname.indexOf("-admin")===-1) add("/media/scripts/agreement-generator-signer-enhancements.js?v=20260912-1","signer");',
    '})();',
    '',
    ...
    '(function(){',
    ' if (location.pathname.indexOf("unplug-agreements-admin") === -1) return;',
