...
export async function onRequest({ env, request }) {
  ...
  lines.push(
    ...
    '  var current=window.__unplugAgreementCurrent||null;',
    '  var path;',
    '  if (preview) {',
    '   if (!current || !current.id) { alert("Choose an agreement first."); return; }',
    '   path="/agreement-forms/admin/"+encodeURIComponent(current.id)+"/preview/document";',
